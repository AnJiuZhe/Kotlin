 ...
 */
class PhotoSearchAdapter(context: Context, photoList: MutableList<PhotoSearch.Search>?)
    : RecyclerView.Adapter<PhotoSearchAdapter.PhotoViewHolder>() {

    private var context: Context? = null
    private var photoList: MutableList<PhotoSearch.Search>? = null
    ...
    override fun onBindViewHolder(holder: PhotoViewHolder, position: Int) {
        ...
        Glide.with(context!!)
                .load(photoList?.get(position)?.url_mid)
